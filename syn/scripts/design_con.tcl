...
set_clock_latency           -min    $CLK_LATENCY        [get_ports  $CLK_NAME]
...
set_false_path  -from   [get_clocks $CLK_NAME]       -to     [get_clocks $TX_CLK_NAME]
set_false_path  -from   [get_clocks $TX_CLK_NAME]    -to     [get_clocks $CLK_NAME]
